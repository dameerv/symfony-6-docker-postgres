...
final class Version20231004234436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE country (id INT NOT NULL, name VARCHAR(255) NOT NULL, code VARCHAR(2) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tax (id INT NOT NULL, country_id INT NOT NULL, format VARCHAR(15) NOT NULL, PRIMARY KEY(id))');
